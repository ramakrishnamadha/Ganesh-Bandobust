...
class ARSessionManager {
  ...
  /// Performs an ARCore hit test at the exact centre of the AR view.
  /// Returns valid plane/feature-point intersections as ARHitTestResult objects.
  Future<List<ARHitTestResult>> hitTestCenter() async {
    try {
